...
label_pholder = Label(second_frame,width = 50,text = 'Policy Holder Information', font = 'times 13 bold underline', anchor = 'w')
...
label_to = Label(second_frame,width = 10 ,text = '         	to ',font = 'times 12  bold',anchor = "w",justify = 'left')
...
entry_dateofquote = Entry(second_frame).grid(row = 2,column = 1)
entry_insured = Entry(second_frame).grid(row =3,column = 1)
entry_policyno = Entry(second_frame).grid(row =4,column = 1)
entry_policyinception = Entry(second_frame).grid(row =5,column = 1)
enrty_periodfrom = Entry(second_frame).grid(row = 6,column =1)
entry_periodto = Entry(second_frame).grid(row = 6,column = 3)
entry_description = Entry(second_frame).grid(row = 9,column = 1)
entry_operation = Entry(second_frame).grid(row =10,column = 1)
...
#Fleet Information
label_fleet = Label(second_frame, width = 50,text = 'Fleet Information',font = 'times 13 bold underline',anchor = 'w')
label_space = Label(second_frame, text = "  ")
label_space.grid(row = 12,column = 0)
label_fleet.grid(row = 13,column = 0)

#Labels for fleet information
label_vcategory = Label(second_frame,text ='Vehicle Category',font = 'times 12 bold underline',justify = 'left',anchor = "w")
...
label_units = Label(second_frame,text = 'No. of units',font = 'times 12 bold underline')
label_value = Label(second_frame,text = 'Value',font = 'times 12 bold underline')
label_damage = Label(second_frame,text = 'Own Damage Limit',font = 'times 12 bold underline')
label_sasria_des = Label(second_frame,text = 'SASRIA Description',font = 'times 12 bold underline')
label_sasria_prem = Label(second_frame,text = 'SASRIA Premium',font = 'times 12 bold underline')
...
label_coverinfo = Label(second_frame, text ='Cover Information',font = 'times 13 bold underline',justify = 'left',anchor = 'w')
...
label_specified = Label(second_frame, width = 50,text = 'Specified Vehicles',font = 'times 13 bold underline',justify = 'left',anchor = 'w' )
